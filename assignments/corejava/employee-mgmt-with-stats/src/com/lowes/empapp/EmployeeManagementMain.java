...
import com.lowes.empapp.service.EmployeeServiceColStatsImpl;

public class EmployeeManagementMain {

	private static Scanner sc;
	private static EmployeeServiceColStatsImpl empService;

	public static void main(String[] args) {
		
		sc = new Scanner(System.in);
		empService = new EmployeeServiceColStatsImpl();
